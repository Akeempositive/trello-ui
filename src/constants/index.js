...
export const CAN_CREATE_USER = 'can_create_new_user';
export const CAN_UPDATE_USER = 'can_update_task_info';
export const CAN_CREATE_TASK = 'can_create_new_task';
export const CAN_UPDATE_TASK = 'can_update_task_info';
export const CAN_SUBMIT_REPORT = 'can_submit_weekly_report'
